...
export function DebitCard({ name="Jordan Student", studentId="FFA-2026-001", career="
    Supervisor", balance=120 }: {name?:string;studentId?:string;career?:string;balance?:number}) {
